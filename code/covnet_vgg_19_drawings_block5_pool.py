...
Original file is located at
    https://colab.research.google.com/github/pabloinsente/CovNet_Human_Drawings/blob/master/code/CovNet_VGG-19_Drawings_bloock5_pool.ipynb
...
for index, row in (cluster.iterrows()): 
  ...
  plt.axis('off')
plt.savefig('cluster_0_block5_pool_drawings.png', dpi=200)
plt.show()
